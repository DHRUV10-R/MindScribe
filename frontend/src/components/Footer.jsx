...
const Footer = () => {
  return (
    <>
      <footer className="bg-black text-[#f2e782] py-10">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center md:text-start">
            <h2 className="text-lg font-semibold mb-4">Products</h2>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-white">Flutter</a></li>
      ...
      <div className="bg-black text-[#f2e782] py-4">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="text-xl font-semibold hidden md:flex">
            Mind<span className="text-white font-bold">Scrible</span>
          </div>
          <div className="text-sm hidden md:flex">
            <p>&copy; 2024 DhiWise PVT. LTD. All rights reserved</p>
          </div>
          <div className="mt-4 md:mt-0 flex space-x-4">
            <a href="#" className="hover:text-white"><FaGithub className="h-6" /></a>
            <a href="#" className="hover:text-white"><BsYoutube className="h-6" /></a>
            <a href="#" className="hover:text-white"><FaLinkedin className="h-6" /></a>
          </div>
        </div>
      </div>
    </>
