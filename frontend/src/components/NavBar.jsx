    ...
    <>
      <nav className="bg-black shadow-lg px-4 py-2">
        <div className="flex items-center justify-between container mx-auto">
          ...
          <div className="mx-6">
            <ul className="hidden md:flex space-x-6 text-[#f2e782]">
              ...
              <NavLink to="/creators" className="hover:text-white">CREATORS</NavLink>
              <NavLink to="/about" className="hover:text-white">ABOUT</NavLink>
              <NavLink to="/contact" className="hover:text-white">CONTACT</NavLink>
              <NavLink to="/notes" className="hover:text-white">NOTES</NavLink>
            </ul>
            <div className="md:hidden text-[#f2e782]" onClick={() => setShow(!show)}>
              {show ? <IoCloseSharp size={24} /> : <AiOutlineMenu size={24} />}
            </div>
        ...
        {show && (
          <div className="bg-black">
            <ul className="flex flex-col h-screen items-center justify-center space-y-3 md:hidden text-xl text-[#f2e782]">
              <NavLink to="/" onClick={() => setShow(!show)} className="hover:text-white">HOME</NavLink>
              <NavLink to="/blogs" onClick={() => setShow(!show)} className="hover:text-white">BLOGS</NavLink>
              <NavLink to="/creators" onClick={() => setShow(!show)} className="hover:text-white">CREATORS</NavLink>
              <NavLink to="/about" onClick={() => setShow(!show)} className="hover:text-white">ABOUT</NavLink>
              <NavLink to="/contact" onClick={() => setShow(!show)} className="hover:text-white">CONTACT</NavLink>
              <NavLink to="/notes" onClick={() => setShow(!show)} className="hover:text-white">NOTES</NavLink>
            </ul>
          </div>
        )}
      </nav>
